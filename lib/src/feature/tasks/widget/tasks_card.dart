...
class TasksCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String datePublication =
        DateFormat('dd.MM.yyyy').format(taskResult.createdAt);
    ...
    return GestureDetector(
      onTap: () {
        context.push(TaskDetailsScreen.routePath, extra: taskResult);
       },
      child: Column(
        ...
        children: [
          ...
          _buildTitle(text.when, dateWhen, context,
